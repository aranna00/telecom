        ...
        <div class="container">
            ...
            <div class="no-margin col-xs-12 col-sm-7 body-holder">
                <div class="body">
                    ...
                    <div class="title"><a href="#">{{ $contract->name }}</a></div>
                    <div class="brand">{{ $phone->brand }} {{ $phone->model }}</div>
                    <div class="excerpt">
                        <p>{!! $contract->excerpt !!}</p>
                    </div>
                    <div class="prices">
        ...
        <div class="container">
            <div class="tab-holder">
                <ul class="nav nav-tabs simple">
                    <li class="active"><a href="#description" data-toggle="tab">Contract Description</a></li>
                    <li><a href="#specifications" data-toggle="tab">Phone Specifications</a></li>
                    <li><a href="#phonedesc" data-toggle="tab">Phone Description</a></li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="phonedesc">
                        {!! $phone->description !!}
                    </div>
                </div>
            </div>
